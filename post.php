    ...
    <div class="pt-5 mt-5">
        <div class="border border-light shadow-sm p-3 mb-5 bg-white rounded">
            ...
            <form action="" method="post">
              ...
              <div class="form-group">
                <label>Actual :</label>
                  <input type="text" name="actual" id="actual" required="required" class="form-control" placeholder="Actual"/>
              </div>
      ...
      <?php
         ...
         if(isset($_POST["submit"])){
          ...
          // echo "Connected successfully";
            ...
            $sql = "INSERT INTO cycle_three_b2_tbl (province,municipality,barangay,sp_id,sp_title,actual) VALUES ('$province','$municipality','$barangay','$sp_id','$sp_title','$actual')";
